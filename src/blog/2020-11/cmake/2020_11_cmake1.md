...
* [Prolem: Setting C++ version in CMakeLists.txt](#Prolem:SettingCversioninCMakeLists.txt)
...
## <a name='Prolem:SettingCversioninCMakeLists.txt'></a>Prolem: Setting C++ version in CMakeLists.txt
